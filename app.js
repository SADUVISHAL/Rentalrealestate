...
const defaultFlats = [
    {
        id: "flat-101",
        title: "Modern 2 BHK Flat in Buxar",
        location: "Near Market, Buxar",
        rent: 12000,
        bhk: "2 BHK",
        area: 900,
    ...
    {
        id: "flat-102",
        title: "Cozy 1 BHK Apartment in Patna",
    ...
    {
        id: "flat-103",
        title: "Premium 3 BHK Luxury Flat in Bangalore",
...
class RealEstateApp {
    ...
    renderFlats(flatsData) {
        ...
        flatsData.forEach(flat => {
            ...
            const whatsappText = encodeURIComponent(`Hello, I'm interested in renting your flat: ${flat.title} located at ${flat.location}. Monthly Rent: ₹${flat.rent}. Please provide more details.`);
                ...
                <div class="property-card-right">
                    <div class="property-card-header">
                        ...
                        <div class="property-location">
                            <i class="fa-solid fa-location-dot"></i> ${flat.location}
                        </div>
                    </div>
    ...
    applyFlatsFilter() {
        ...
        let filtered = this.flats.filter(flat => {
            // Location
            if (searchLoc && !flat.location.toLowerCase().includes(searchLoc) && !flat.title.toLowerCase().includes(searchLoc)) {
                return false;
            }
            // Budget
    ...
    renderPGs(pgsData) {
        ...
        pgsData.forEach(pg => {
            ...
            const whatsappText = encodeURIComponent(`Hello, I'm interested in booking a PG room: ${pg.name} located at ${pg.location}. Rent starts at: ₹${pg.rent}. Preferred sharing: ${pg.occupancy}. Please guide me on booking.`);
            const whatsappUrl = `https://wa.me/${this.whatsappNumber}?text=${whatsappText}`;
            ...
            card.innerHTML = `
                ...
                <div class="property-card-right">
                    <div class="property-card-header">
                        ...
                        <div class="property-location">
                            <i class="fa-solid fa-location-dot"></i> ${pg.location}
                        </div>
                    </div>
                    <div class="property-specs">
    ...
    applyPGsFilter() {
        ...
        let filtered = this.pgs.filter(pg => {
            // Location
            if (searchLoc && !pg.location.toLowerCase().includes(searchLoc) && !pg.name.toLowerCase().includes(searchLoc)) {
                return false;
            }
            // Budget
    ...
    showDetailModal(type, id) {
        ...
        document.getElementById("modal-image").src = item.image || (type === "flat" ? "images/flat_1.png" : "images/pg_1.png");
        document.getElementById("modal-title").textContent = item.title || item.name;
        document.getElementById("modal-location").innerHTML = `<i class="fa-solid fa-location-dot"></i> ${item.location}`;
        ...
        if (type === "flat") {
            ...
            queryText = `Hi, I saw your PG listing: ${item.name} in ${item.location} on your Real Estate portal and want to check sharing details for ${item.occupancy}.`;
        }
